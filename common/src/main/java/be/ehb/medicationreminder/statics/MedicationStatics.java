package be.ehb.medicationreminder.statics;

/**
 * Created by davy.van.belle on 1/07/2015.
 */
public class MedicationStatics {
    ...
    public static final String MED_PIC = "BE.EHB.MEDREM.MED.PIC";
    public static final String MED_ALARM_LIST = "MED_ALARM_LIST" ;
