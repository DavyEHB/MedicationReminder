package be.ehb.medicationreminder.mobile.UI;
 ...
 * in a {@link MedicationListActivity}.
 * <p/>
...
public class MedicationDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putInt(MedicationDetailFragment.ARG_ITEM_ID,
                    getIntent().getIntExtra(MedicationDetailFragment.ARG_ITEM_ID,0));
            MedicationDetailFragment fragment = new MedicationDetailFragment();
            fragment.setArguments(arguments);
            getFragmentManager().beginTransaction()
                    .add(R.id.medication_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, MedicationListActivity.class));
            return true;
        }
